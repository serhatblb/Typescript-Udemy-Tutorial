...
console.log(getRandomElement(numbers)); // istersek < > içinde degeri verebiliriz
console.log(getRandomElement(isimler));
var degiskenlerim = [true, false, false, true];
console.log(getRandomElement(degiskenlerim));
// 2) Generic Constraints
function merge(obj1, obj2) {
    return __assign(__assign({}, obj1), obj2);
}
var person = merge({ name: "Serhat" }, { age: 28 });
console.log(person);
var month = {
    key: 1,
    value: 'January'
